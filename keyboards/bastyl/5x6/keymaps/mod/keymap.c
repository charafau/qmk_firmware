...
[_BASE] = LAYOUT(
   ...
   KC_LCTL, KC_Z, KC_X, KC_C, KC_V, KC_B,                                   KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT,
                KC_LGUI, KC_LALT, KC_SPC,                                   KC_ENT, LT(ADJUST, KC_TAB), LT(RAISE, KC_BSPC),
                          LOWER,  KC_DEL,                                   KC_ESC, RAISE
),
...
[_RAISE] = LAYOUT(
   ...
   ____, KC_MUTE, KC_VOLD, KC_VOLU, KC_BRIU , ____,                KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, ____, ____,
   ____, KC_MPRV, KC_MPLY, KC_MNXT, KC_BRID, ____,                    ____, ____, ____, ____, ____, ____,
                                  ____, ____, ____,                  ____, ____, ____,
                                       ____,  ____,                  ____, ____
),
